...
/* module table-2: table sorter - file jquery.tablesorter.min */
...
/* module table-2: table sorter - file jquery.tablesorter.min END */
...
$(document).ready(function() {
		...
		var myAccordeon2 = a11yAccordeon({
		  parentSelector: '#accordeon2',
		  showSearch: false,
		  speed: 200,
		  accordeonItemSelector: ".akkordeon-inner",
